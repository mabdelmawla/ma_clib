 ...
 */
/**
 @file		ma_sha_common.c
 @brief		This module contains SHA Common operations and constants implementation
 @author		M. Abdelmawla
 @date		11 JAN 2020
 @version	1.0
...
#include "ma_sha_common.h"

// SHA Constants (Reference: FIPS PUB 180-3) section 4.2
const _t_ma_u32 ga_ma_sha_cmn_sha1_k[] = { 0x5a827999, 0x6ed9eba1, 0x8f1bbcdc,
		0xca62c1d6 };
